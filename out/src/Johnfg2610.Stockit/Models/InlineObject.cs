...
{ 
    ...
    {
        /// <summary>
        /// Gets or Sets AmountChange
        /// </summary>
        [DataMember(Name="amountChange", EmitDefaultValue=false)]
        ...
        public bool Equals(InlineObject other)
        {
            ...
            return 
                (
                    ...
                    AmountChange.Equals(other.AmountChange)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AmountChange.GetHashCode();
                return hashCode;
            }
        }
